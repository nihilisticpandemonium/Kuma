...
namespace Kuma.Expressions {
    /// <summary>
    ///     Methods for KumaExpression that provide factory expressions similar to how DLR Expression.* functions work.
    /// </summary>
    public partial class KumaExpression {
        /// <summary>
        ...
        public static BinaryExpression Compare (Expression left, Expression right) {
            return new BinaryExpression (left, right, KumaExpressionType.Compare);
        }

        public static BinaryExpression OrButNotAlso (Expression left, Expression right) {
            return new BinaryExpression (left, right, KumaExpressionType.LogicalXor);
        }

        public static BinaryExpression Match (Expression left, Expression right) {
            return new BinaryExpression (left, right, KumaExpressionType.Match);
        }

        public static BinaryExpression NotMatch (Expression left, Expression right) {
            return new BinaryExpression (left, right, KumaExpressionType.NotMatch);
        }
        ...
        public static LoopExpression KumaLoop (Expression body) {
        ...
        public static BlockExpression KumaBlock (params Expression[] body) {
            return new BlockExpression (body.ToList (), new KumaScope ());
        }
