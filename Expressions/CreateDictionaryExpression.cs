...
namespace Kuma.Expressions {
    ...
    ///     TODO: Update summary.
    /// </summary>
    public class CreateDictionaryExpression : KumaExpression {
        ...
        public override Type Type {
            get { return typeof (KumaDictionary); }
        }

        public override Expression Reduce() {
            return Operation.CreateDictionary(typeof (KumaDictionary), Constant(Values));
        }
