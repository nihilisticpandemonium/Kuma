// -----------------------------------------------------------------------
// <copyright file="KumaExpression.cs" Company="Michael Tindal">
...
namespace Kuma.Expressions {
    /// <summary>
    ///     Base class for Kuma abstract syntax tree expressions.
    /// </summary>
    public abstract partial class KumaExpression : Expression, IScopeExpression {
        private KumaScope _scope;

        /// <summary>
        ///     All Kuma expressions are extension expressions, so they always return true.
        /// </summary>
        ...
        /// <summary>
        ///     Returns ExpressionType.Extension for all Kuma expressions.
        /// </summary>
        ...
        /// <summary>
        ///     This method should reduce the Kuma expression into either more Kuma expressions or base DLR
