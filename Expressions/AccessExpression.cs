...
namespace Kuma.Expressions {
    ...
    /// </summary>
    public class AccessExpression : KumaExpression {
        ...
        /// <summary>
        ///     Reduces this expression into a dynamic expression using <c><see cref="Kuma.Runtime.Operation" />.Access</c>
        /// </summary>
        ...
        /// <summary>
        ///     Returns a <see cref="System.String" /> that represents the current <see cref="Kuma.Expressions.AccessExpression" />.
        /// </summary>
        /// <returns>A <see cref="System.String" /> that represents the current <see cref="Kuma.Expressions.AccessExpression" />.</returns>
