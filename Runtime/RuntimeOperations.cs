...
namespace Kuma.Runtime {
    ...
    public static partial class RuntimeOperations {
        ...
        private static dynamic Binary(object left, object right, E type, object _scope) {
            ...
            return Dynamic(typeof (object), new InteropBinder.Binary((KumaScope) _scope, type),
                args);
        }
        ...
        private static dynamic Match(object rawLeft, object rawRight, KumaExpressionType kumaBinaryNodeType, object rawScope)
        {
            ...
            if (!regex.Match(str).Success) return kumaBinaryNodeType == KumaExpressionType.NotMatch;
        ...
        private static dynamic Unary(object expr, E type, object _scope) {
            ...
            return Dynamic(typeof (object), new InteropBinder.Unary((KumaScope) _scope, type), args);
        }
