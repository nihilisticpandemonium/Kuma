...
using BinaryExpression = Kuma.Expressions.BinaryExpression;
using BlockExpression = Kuma.Expressions.BlockExpression;
using SwitchExpression = Kuma.Expressions.SwitchExpression;
using UnaryExpression = Kuma.Expressions.UnaryExpression;

namespace Kuma.Runtime {
    /// <summary>
    ///     Base visitor for Kuma expression visitors.
    /// </summary>
    public abstract class KumaExpressionVisitor : ExpressionVisitor {
