...
namespace Kuma.Runtime {
    ...
    ///     TODO: Update summary.
    /// </summary>
    public partial class KumaClass : IKumaDynamicMetaObjectProvider {
        ...
        internal sealed class Meta : KumaMetaObject<KumaClass> {
            public Meta(Expression expression, BindingRestrictions restrictions, KumaClass value)
