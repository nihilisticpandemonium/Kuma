...
// <copyright file="KumaFunction.cs" Company="Michael Tindal">
...
namespace Kuma.Runtime {
    ...
    ///     TODO: Update summary.
    /// </summary>
    public partial class KumaFunction {
        #region Properties
        ...
        public override string ToString() {
            return string.Format("[KumaFunction: Arguments={0}, Name={1}, Body={2}, Context={3}, Scope={4}]",
